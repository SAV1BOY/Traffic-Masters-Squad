...
> **Agents involved**: Strategist, Media Buyer, Creative Producer, Tracking Specialist, QA Analyst

## Trigger
New campaign brief approved by client or internal stakeholder.

## Steps
1. Strategy Definition → Agent: Strategist → Framework: GECO → Output: Campaign strategy document with objectives, audiences, budget allocation
2. Audience Research → Agent: Strategist → Framework: Sobral Audience Matrix → Output: Audience segments with temperature mapping (cold/warm/hot)
3. Creative Production → Agent: Creative Producer → Framework: Hook-Story-Offer → Output: Ad creatives in all required formats and placements
...
5. Tracking Setup → Agent: Tracking Specialist → Framework: UTM + CAPI → Output: Pixels fired, CAPI configured, UTMs appended, test conversions verified
6. Internal QA → Agent: QA Analyst → Framework: Pre-Launch Checklist → Output: QA sign-off document
