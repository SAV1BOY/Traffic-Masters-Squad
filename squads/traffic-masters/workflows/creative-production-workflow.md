...
- [ ] Each creative has a clear hypothesis to test
- [ ] All platform specs met (dimensions, file size, duration, text ratio)
- [ ] Ad policy compliance checked (no restricted claims, proper disclaimers)
- [ ] Brand guidelines followed (colors, fonts, tone)
- [ ] Captions/subtitles on all video ads
- [ ] Mobile-first design verified
- [ ] Asset naming convention followed

## Output
Production-ready creative batch with documentation.
Testing matrix mapping creatives to hypotheses.
Organized asset library with performance tracking.

## Creative Formats Checklist
- Static: 1080x1080, 1080x1350, 1200x628
- Video: 1080x1080, 1080x1920, 1920x1080 (15s, 30s, 60s)
- Carousel: 1080x1080 (3-5 cards)
- Story/Reel: 1080x1920 (9:16)

## Notes
- Always produce hook variations (different first 3 seconds)
