...
- [ ] Registration page and tracking fully tested before capture phase
- [ ] All email/ad sequences aligned with launch calendar
- [ ] Budget pacing matches launch phase requirements
- [ ] Creative assets ready for each phase before launch starts
- [ ] Real-time monitoring during open and close cart days
- [ ] Post-launch debrief completed within 7 days of close

## Output
Complete launch performance report with revenue, ROAS, CPL, and conversion rates by phase.
Documented playbook for future launches.
Audience assets built during launch for future campaigns.

## Budget Distribution (Typical)
- Pre-Launch: 10% | Capture: 25% | Warm-Up: 5%
- Open Cart: 20% | Sustain: 15% | Urgency: 10% | Close: 10% | Post: 5%

## Notes
- Sobral principle: 80% of sales come from open cart day and close cart day
