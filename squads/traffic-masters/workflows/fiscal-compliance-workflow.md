...
> **Agents involved**: Finance Specialist, Squad Lead, Media Buyer

## Trigger
Monthly fiscal close, new ad account setup, or audit request from finance/tax authority.

## Steps
1. Invoice Collection → Agent: Finance Specialist → Framework: NF Tracking → Output: All platform invoices (Notas Fiscais) collected for the period
2. Spend Reconciliation → Agent: Finance Specialist → Framework: Three-Way Match → Output: Platform spend matched against NFs and bank statements
3. Currency Reconciliation → Agent: Finance Specialist → Framework: BRL/USD Matching → Output: Exchange rate variations documented and reconciled
4. Tax Classification → Agent: Finance Specialist → Framework: Brazilian Tax Code → Output: Ad spend properly classified (ISS, IOF for international payments)
5. LGPD Compliance Check → Agent: Finance Specialist → Framework: LGPD Audit → Output: Data processing activities verified against LGPD requirements
...
7. Report Generation → Agent: Finance Specialist → Framework: Fiscal Report Template → Output: Monthly fiscal compliance report with all documentation
8. Archive → Agent: Finance Specialist → Framework: Document Retention → Output: All documents archived per legal retention requirements (5+ years)
