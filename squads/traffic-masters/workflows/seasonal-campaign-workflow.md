...
- [ ] All creatives production-ready 2 weeks before peak
- [ ] Budget approved with peak-period surge allocation
- [ ] Tracking verified under high-traffic conditions
- [ ] Landing pages load-tested for traffic spikes
- [ ] Backup creatives ready for rapid deployment
- [ ] Post-mortem completed within 7 days of season end

## Output
Complete seasonal campaign playbook (reusable for next year).
Performance report with YoY comparison.
Lessons learned document for future seasons.

## Brazilian Seasonal Calendar
- Carnaval (Feb/Mar) | Dia das Maes (May) | Dia dos Namorados (Jun 12)
- Black Friday BR (Nov) | Christmas (Dec) | Back to School (Jan/Feb)

## Notes
- CPMs increase 30-80% during peak seasons; factor into CPA projections
